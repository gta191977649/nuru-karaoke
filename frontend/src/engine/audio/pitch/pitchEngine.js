...
class PitchEngine {
  ...
  async _ensureWorklet(audioContext) {
    ...
    this._workletReady = audioContext.audioWorklet.addModule(pitchWorkletUrl)
  ...
  _postWorkletConfig() {
    ...
    this._workletNode.port.postMessage({
      ...
      breakToleranceMs: this._config.breakToleranceMs,
      enablePitchSnap: this._config.enablePitchSnap,
      snapToleranceSemis: this._config.snapToleranceSemis,
      ...
      aubioTolerance: this._config.aubioTolerance,
